...
$(LIBIMLUA_JP2_DLL): $(LIBIM_JP2_DLL) $(LIBIMLUA_JP2)
...
$(LIBIMLUA_PROCESS_DLL): $(LIBIM_PROCESS_DLL) $(LIBIMLUA_PROCESS)
...
$(LIBIMLUA_FFTW_DLL): $(LIBIM_FFTW_DLL) $(LIBIMLUA_PROCESS_DLL) $(LIBIMLUA_FFTW)
...
$(LIBCDLUA_DLL): $(LIBCD_DLL) $(LIBLUA)
	$(TARGET_CC) -s -shared -o $(LIBCDLUA_DLL) "-Wl,--out-implib,$(CD)/lib/$(TEC_UNAME)_dll/libcdlua$(LUA_DLLVER).dll.a" "$(CD)/obj/cdlua$(LUA_DLLVER)/$(TEC_UNAME)/Lua"/*.o -L$(CD)/lib/$(TEC_UNAME)_dll -lcd -L$(LUA)/lib/$(TEC_UNAME)/lib -llua$(LUA_DLLVER)

$(LIBCDLUAPDF_DLL): $(LIBCDPDF_DLL) $(LIBCD_DLL) $(LIBCDLUAPDF) $(LIBLUA)
...
$(LIBCDLUAGL_DLL): $(LIBCDGL_DLL) $(LIBCD_DLL) $(LIBCDLUAGL) $(LIBLUA)
...
$(LIBCDLUACONTEXTPLUS_DLL): $(LIBCDCONTEXTPLUS_DLL) $(LIBCD_DLL) $(LIBCDLUACONTEXTPLUS) $(LIBLUA)
...
$(LIBCDLUAIM_DLL): $(LIBCDIM_DLL) $(LIBCD_DLL) $(LIBCDLUAIM) $(LIBLUA) $(LIBIMLUA_DLL) $(LIBIM_DLL)
...
#LIBCDLUAPDF_DLL          := $(CD)/lib/$(TEC_UNAME)_dll/$(TARGET_DLIBPRE)cdluapdf$(LUAPDF_DLLVER).$(TARGET_DLIBEXT)
#LIBCDLUAGL_DLL           := $(CD)/lib/$(TEC_UNAME)_dll/$(TARGET_DLIBPRE)cdluagl$(LUAGL_DLLVER).$(TARGET_DLIBEXT)
#LIBCDLUACONTEXTPLUS_DLL  := $(CD)/lib/$(TEC_UNAME)_dll/$(TARGET_DLIBPRE)cdluacontextplus$(LUACONTEXTPLUS_DLLVER).$(TARGET_DLIBEXT)
#LIBCDLUAIM_DLL           := $(CD)/lib/$(TEC_UNAME)_dll/$(TARGET_DLIBPRE)cdluaim$(LUAIM_DLLVER).$(TARGET_DLIBEXT)
...
$(LIBIUPGL_DLL): $(LIBIUPGL) $(LIBIUP_DLL)
	mkdir -p $(IUP)/lib/$(TEC_UNAME)_dll
	$(TARGET_CC) -s -shared -static-libgcc -o $(LIBIUPGL_DLL) "-Wl,--out-implib,$(IUP)/lib/$(TEC_UNAME)_dll/libiupgl.dll.a" "$(IUP)/obj/iupgl/$(TEC_UNAME)"/*.o -L$(IUP_DLL)/lib/$(TEC_UNAME)_dll -liup -lopengl32 -lglu32 -lglaux -lgdi32


$(LIBIUPGLCONTROLS_DLL): $(LIBIUPGLCONTROLS) $(LIBIUP_DLL) $(LIBFTGL_DLL) $(LIBIUPGL_DLL)
	mkdir -p $(IUP)/lib/$(TEC_UNAME)_dll
	$(TARGET_CC) -s -shared -static-libgcc -o $(LIBIUPGLCONTROLS_DLL) "-Wl,--out-implib,$(IUP)/lib/$(TEC_UNAME)_dll/libiupglcontrols.dll.a" "$(IUP)/obj/iupglcontrols/$(TEC_UNAME)"/*.o -L$(IUP)/lib/$(TEC_UNAME)_dll -liupgl -L$(IUP_DLL)/lib/$(TEC_UNAME)_dll -liup -L$(FTGL)/lib/$(TEC_UNAME)_dll -lftgl -lopengl32 -lglu32 -lglaux -lgdi32
...
$(LIBIUP_MGLPLOT_DLL): $(LIBIUP_MGLPLOT) $(LIBIUP_PLOT_DLL) $(LIBIUP_DLL) $(LIBIUPGL_DLL)
	mkdir -p $(IUP)/lib/$(TEC_UNAME)_dll
	$(TARGET_CXX) -s -shared -static-libgcc -o $(LIBIUP_MGLPLOT_DLL) "-Wl,--out-implib,$(IUP)/lib/$(TEC_UNAME)_dll/libiup_mglplot.dll.a" "$(IUP)/obj/iup_mglplot/$(TEC_UNAME)"/*.o -L$(IUP)/lib/$(TEC_UNAME)_dll -liup_plot -liupgl -L$(IUP_DLL)/lib/$(TEC_UNAME)_dll -liup -lopengl32 -lglu32 -lglaux
...
$(LIBIUPLUA_DLL): $(LIBIUP_DLL) $(LIBLUA)
	$(TARGET_CC) -s -shared -o $(LIBIUPLUA_DLL) "-Wl,--out-implib,$(IUP)/lib/$(TEC_UNAME)_dll/libiuplua$(LUA_DLLVER).dll.a" "$(IUP)/obj/iuplua$(LUA_DLLVER)/$(TEC_UNAME)/Lua"/*.o -L$(IUP_DLL)/lib/$(TEC_UNAME)_dll -liup -L$(LUA)/lib/$(TEC_UNAME)/lib -llua$(LUA_DLLVER)
...
$(LIBIUPLUACONTROLS_DLL): $(LIBIUPCONTROLS_DLL) $(LIBIUP_DLL) $(LIBCDLUA_DLL) $(LIBIUPLUACONTROLS) $(LIBLUA)
...
$(LIBIUPLUAMATRIXEX_DLL): $(LIBIUPMATRIXEX_DLL) $(LIBIUP_DLL) $(LIBIUPLUAMATRIXEX) $(LIBLUA)
...
$(LIBIUPLUAGLCONTROLS_DLL): $(LIBIUPGLCONTROLS_DLL) $(LIBIUP_DLL) $(LIBIUPLUAGLCONTROLS) $(LIBLUA)
...
$(LIBIUPLUA_PLOT_DLL): $(LIBIUP_PLOT_DLL) $(LIBIUP_DLL) $(LIBCDLUA_DLL) $(LIBIUPLUA_PLOT) $(LIBLUA)
...
$(LIBIUPLUA_MGLPLOT_DLL): $(LIBIUP_MGLPLOT_DLL) $(LIBIUP_DLL) $(LIBIUPLUA_MGLPLOT) $(LIBLUA)
...
$(LIBIUPLUA_SCINTILLA_DLL): $(LIBIUP_SCINTILLA_DLL) $(LIBIUP_DLL) $(LIBIUPLUA_SCINTILLA) $(LIBLUA)
...
$(LIBIUPLUAIM_DLL): $(LIBIUPIM_DLL) $(LIBIUP_DLL) $(LIBIMLUA_DLL) $(LIBIUPLUAIM) $(LIBLUA)
...
$(LIBIUPLUAIMGLIB_DLL): $(LIBIUPIMGLIB_DLL) $(LIBIUP_DLL) $((LIBIUPLUAIMGLIB) $(LIBLUA)
...
$(LIBIUPLUATUIO_DLL): $(LIBIUPTUIO_DLL) $(LIBIUP_DLL) $((LIBIUPLUATUIO) $(LIBLUA)
...
$(LIBIUPLUAOLE_DLL): $(LIBIUPOLE_DLL) $(LIBIUP_DLL) $((LIBIUPLUAOLE) $(LIBLUA)
...
install: all
	mkdir -p "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/bin"
	mkdir -p "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/include/lua$(LUA_DLLVER)"
	mkdir -p "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/include"
	mkdir -p "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/include"
	mkdir -p "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/include"
	mkdir -p "$(current_dir)/output/ftgl-$(FTGL_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/ftgl-$(FTGL_VER)-$(TARGET)/$(TARGET)/include"
	mkdir -p "$(current_dir)/output/freetype-$(FREETYPE_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/freetype-$(FREETYPE_VER)-$(TARGET)/$(TARGET)/include"
	mkdir -p "$(current_dir)/output/zlib-$(ZLIB_VER)-$(TARGET)/$(TARGET)/lib"
	mkdir -p "$(current_dir)/output/zlib-$(ZLIB_VER)-$(TARGET)/$(TARGET)/include"
ifneq (,$(findstring mingw32,$(TARGET))) #begin windows
	cp "$(LIBLUA_DLLA)"         "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIM_DLLA)"             "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIM_JP2_DLLA)"         "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIM_PROCESS_DLLA)"     "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIM_FFTW_DLLA)"        "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIM_LZO_DLLA)"         "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIM_PROCESS_OMP_DLLA)" "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIMLUA_DLLA)"          "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIMLUA_JP2_DLLA)"      "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIMLUA_PROCESS_DLLA)"  "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIMLUA_FFTW_DLLA)"     "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCD_DLLA)"               "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCD_PDFLIB_DLLA)"        "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDPDF_DLLA)"            "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDGL_DLLA)"             "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDIM_DLLA)"             "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDCONTEXTPLUS_DLLA)"    "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUA_DLLA)"            "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUAPDF_DLLA)"         "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUAGL_DLLA)"          "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUACONTEXTPLUS_DLLA)" "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUAIM_DLLA)"          "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_DLLA)"              "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPCD_DLLA)"            "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPCONTROLS_DLLA)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPGL_DLLA)"            "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPGLCONTROLS_DLLA)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPMATRIXEX_DLLA)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_PLOT_DLLA)"         "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_MGLPLOT_DLLA)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_SCINTILLA_DLLA)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPIM_DLLA)"            "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPIMGLIB_DLLA)"        "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPOLE_DLLA)"           "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPTUIO_DLLA)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_DLLA)"           "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUACD_DLLA)"         "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUACONTROLS_DLLA)"   "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAMATRIXEX_DLLA)"   "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAGL_DLLA)"         "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAGLCONTROLS_DLLA)" "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_PLOT_DLLA)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_MGLPLOT_DLLA)"   "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_SCINTILLA_DLLA)" "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAIM_DLLA)"         "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAIMGLIB_DLLA)"     "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUATUIO_DLLA)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAOLE_DLLA)"        "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCD_PDFLIB)"        "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDPDF)"            "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUAPDF)"         "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPOLE)"           "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAOLE)"        "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_MGLPLOT)"   "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_SCINTILLA)" "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_MGLPLOT)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_SCINTILLA)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCD_PDFLIB_DLL)"        "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDPDF_DLL)"            "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBCDLUAPDF_DLL)"         "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPOLE_DLL)"           "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUAOLE_DLL)"        "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_MGLPLOT_DLL)"   "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUPLUA_SCINTILLA_DLL)" "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_MGLPLOT_DLL)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
	cp "$(LIBIUP_SCINTILLA_DLL)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib"
endif
	cp "$(LIBFREETYPE)" "$(current_dir)/output/freetype-$(FREETYPE_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBZLIB)" "$(current_dir)/output/zlib-$(ZLIB_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBFTGL)" "$(current_dir)/output/ftgl-$(FTGL_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBLUA)"            "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM)"             "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_JP2)"         "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_PROCESS)"     "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_FFTW)"        "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_LZO)"         "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_PROCESS_OMP)" "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA)"          "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_JP2)"      "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_PROCESS)"  "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_FFTW)"     "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCD)"                "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDGL)"              "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDIM)"              "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDCONTEXTPLUS)"     "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUA)"             "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUAGL)"           "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUACONTEXTPLUS)"  "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUAIM)"           "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUP)"               "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPCD)"             "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPCONTROLS)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPGL)"             "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPGLCONTROLS)"     "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPMATRIXEX)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUP_PLOT)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPIM)"             "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPIMGLIB)"         "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPTUIO)"           "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUA)"            "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUACD)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUACONTROLS)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAMATRIXEX)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAGL)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAGLCONTROLS)"  "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUA_PLOT)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAIM)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAIMGLIB)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUATUIO)"        "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBFREETYPE_DLL)" "$(current_dir)/output/freetype-$(FREETYPE_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBZLIB_DLL)" "$(current_dir)/output/zlib-$(ZLIB_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBFTGL_DLL)" "$(current_dir)/output/ftgl-$(FTGL_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBLUA_DLL)"            "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_DLL)"             "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_JP2_DLL)"         "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_PROCESS_DLL)"     "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_FFTW_DLL)"        "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_LZO_DLL)"         "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIM_PROCESS_OMP_DLL)" "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_DLL)"          "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_JP2_DLL)"      "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_PROCESS_DLL)"  "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIMLUA_FFTW_DLL)"     "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCD_DLL)"                "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDGL_DLL)"              "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDIM_DLL)"              "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDCONTEXTPLUS_DLL)"     "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUA_DLL)"             "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUAGL_DLL)"           "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUACONTEXTPLUS_DLL)"  "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBCDLUAIM_DLL)"           "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUP_DLL)"               "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPCD_DLL)"             "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPCONTROLS_DLL)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPGL_DLL)"             "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPGLCONTROLS_DLL)"     "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPMATRIXEX_DLL)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUP_PLOT_DLL)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPIM_DLL)"             "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPIMGLIB_DLL)"         "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPTUIO_DLL)"           "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUA_DLL)"            "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUACD_DLL)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUACONTROLS_DLL)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAMATRIXEX_DLL)"    "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAGL_DLL)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAGLCONTROLS_DLL)"  "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUA_PLOT_DLL)"       "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAIM_DLL)"          "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUAIMGLIB_DLL)"      "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LIBIUPLUATUIO_DLL)"        "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/lib/"
	cp "$(LUA)/lib/$(TEC_UNAME)/include/"* "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/include/lua$(LUA_DLLVER)/"
	cp "$(LUA)/lib/$(TEC_UNAME)/bin/lua$(LUA_DLLVER)$(TARGET_EXEEXT)" "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/bin/lua$(LUA_DLLVER)$(TARGET_EXEEXT)"
	cp "$(LUA)/lib/$(TEC_UNAME)/bin/luac$(LUA_DLLVER)$(TARGET_EXEEXT)" "$(current_dir)/output/lua-$(LUA_VER)-$(TARGET)/$(TARGET)/bin/luac$(LUA_DLLVER)$(TARGET_EXEEXT)"
	cp -r "$(FTGL)/include/"* "$(current_dir)/output/ftgl-$(FTGL_VER)-$(TARGET)/$(TARGET)/include/"
	cp -r "$(ZLIB)/include/"* "$(current_dir)/output/zlib-$(ZLIB_VER)-$(TARGET)/$(TARGET)/include/"
	cp -r "$(FREETYPE)/include/"* "$(current_dir)/output/freetype-$(FREETYPE_VER)-$(TARGET)/$(TARGET)/include/"
	cp "$(IM)/include/"*.h "$(current_dir)/output/im-$(IM_VER)-$(TARGET)/$(TARGET)/include"
	cp "$(CD)/include/"*.h "$(current_dir)/output/cd-$(CD_VER)-$(TARGET)/$(TARGET)/include"
	cp "$(IUP)/include/"*.h "$(current_dir)/output/iup-$(IUP_VER)-$(TARGET)/$(TARGET)/include"
ifneq (,$(findstring linux,$(TARGET))) #begin linux
    mkdir -p "$(current_dir)/output/x11-$(TARGET)/$(TARGET)/lib"
    mkdir -p "$(current_dir)/output/x11-$(TARGET)/$(TARGET)/include"
	cp -r "$(X11)/iup_$(TARGET)/lib/"*     "$(current_dir)/output/x11-$(TARGET)/$(TARGET)/lib"
	cp -r "$(X11)/iup_$(TARGET)/include/"* "$(current_dir)/output/x11-$(TARGET)/$(TARGET)/include"
	rm "$(current_dir)/output/x11-$(TARGET)/$(TARGET)/lib/"*.la
	rm -rf "$(current_dir)/output/x11-$(TARGET)/$(TARGET)/lib/pkgconfig"
endif
